Public Class frm_faktur_konsinyasi 
    ...
    Private Sub kode_customer_parent_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles kode_customer_parent.EditValueChanged
        Try
            rcd_list.Clear()
        Catch ex As Exception
